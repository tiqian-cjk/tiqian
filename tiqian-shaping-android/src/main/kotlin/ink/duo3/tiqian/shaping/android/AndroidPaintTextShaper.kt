...
class AndroidPaintTextShaper(
    ...
    override fun shape(input: ShapingInput): ShapingResult {
        ...
        val useHanContext = displayText.isNotEmpty() &&
            (
                input.fontDecision.role == ink.duo3.tiqian.font.FontRole.CjkText ||
                    input.fontDecision.role == ink.duo3.tiqian.font.FontRole.CjkPunctuation
                )
    ...
    private fun measureHalt(
        ...
        if (input.fontDecision.role != ink.duo3.tiqian.font.FontRole.CjkPunctuation) return null
...
class SystemAndroidTypefaceResolver : AndroidTypefaceResolver {
    ...
    override fun resolve(input: ShapingInput): android.graphics.Typeface =
        when (input.fontDecision.role) {
            ink.duo3.tiqian.font.FontRole.CjkText,
            ink.duo3.tiqian.font.FontRole.CjkPunctuation,
