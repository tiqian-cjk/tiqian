...
### 3. 拉伸优先顺序与 CLREQ 有出入——已解决（Slice 11，ADR 0004 amendment：去标点档；2026-06-12 复审三条：CjkInterChar 限定双侧 CJK——标点↔西文不拉伸；末档去 cap 必然填满；末档为均匀 tracking——实心侧与折叠对同份额参与，不优先补齐）
